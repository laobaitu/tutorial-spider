...
<img alt="tuple-0" data-src="/files/attachments/923973516787680/0" src="/static/img/loading.svg"/>

当我们把list的元素`'A'`和`'B'`修改为`'X'`和`'Y'`后，tuple变为：

<img alt="tuple-1" data-src="/files/attachments/923973647515872/0" src="/static/img/loading.svg"/>
