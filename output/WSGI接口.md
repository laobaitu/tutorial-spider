...
<img alt="wsgiref-start" data-src="/files/attachments/950751913543456" src="/static/img/loading.svg"/>

注意：如果`8000`端口已被其他程序占用，启动将失败，请修改成其他端口。

启动成功后，打开浏览器，输入`http://localhost:8000/`，就可以看到结果了：

<img alt="hello-web" data-src="/files/attachments/950751878708448" src="/static/img/loading.svg"/>

在命令行可以看到wsgiref打印的log信息：

<img alt="wsgiref-log" data-src="/files/attachments/950751840957632" src="/static/img/loading.svg"/>
...
<img alt="hello-michael" data-src="/files/attachments/950751959286720" src="/static/img/loading.svg"/>
