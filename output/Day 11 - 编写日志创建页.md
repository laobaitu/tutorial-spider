...
<img alt="mvvm-1" data-src="/files/attachments/956056345770752" src="/static/img/loading.svg"/>

如果我们在JavaScript逻辑中修改了Model，这个修改会立刻反映到View上。试试在JavaScript控制台输入`vm.name = 'MVVM简介'`，可以看到文本框的内容自动被同步了：

<img alt="mvvm-2" data-src="/files/attachments/956056362546592" src="/static/img/loading.svg"/>
