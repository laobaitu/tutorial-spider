...
如果你正在使用Windows，请参考[安装Python](/wiki/1016959663602400/1016959856222624)一节的内容，确保安装时勾选了`pip`和`Add python.exe to Path`。
...
<img alt="且慢" data-src="/files/attachments/1183096336546240/l" src="/static/img/loading.svg"/>
